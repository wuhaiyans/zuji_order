...
class WithholdAdvanceOne implements ShortMessage {
    ...
    public function notify(){
         ...
         */
        $time = 60 * 60 * 12;
        if(redisIncr('WithholdAdvanceOne'.$this->business_no, $time)>1) {
            LogApi::debug("[WithholdAdvanceOne]短信已经发送");
            return false;
        }
        ...
        \App\Lib\Common\LogApi::debug('[cronWithholdMessage:'.$instalmentInfo['order_no'].'提前1天扣款短信]');
