...
class ImportUserCertified extends Command
{
    ...
    public function handle()
    {
        ...
        $total = DB::connection('mysql_01')->table("zuji_order2")->where(['business_key'=>1])->whereIn("appid",$appid)->count();
        ...
        try{
            ...
            $arr =[];
            do {
                $orderList = DB::connection('mysql_01')->table('zuji_order2')->where('business_key','=',1)->whereIn("appid",$appid)->forPage($page,$limit)->get();
