...
class DeliveryStatus{
     ...
     * @var int 未配货
     */
    const DeliveryGoodsStatus0 = 0;
    /**
     * @var int 部分配货完成
     */
    const DeliveryGoodsStatus1 = 1;
    /**
     * @var int 全部配货完成
     */
    const DeliveryGoodsStatus2 = 2;
    //--------------------------------------------------------------------------------------------
    //--+ 发货清单单状态 end --------------------------------------------------------------------------
    //--------------------------------------------------------------------------------------------
    /**
     ...
     * @return array    订单状态列表
     */
    public static function getGoodsStatusList(){
        return [
            self::DeliveryGoodsStatus0 => '未配货',
            self::DeliveryGoodsStatus1 => '部分配货完成',
            self::DeliveryGoodsStatus2 => '全部配货完成',
        ];
    }
     ...
     * @return string 发货状态名称
     */
    public static function getGoodsStatusName($status){
        $list = self::getGoodsStatusList();
        if( isset($list[$status]) ){
            return $list[$status];
        }
        return '';
