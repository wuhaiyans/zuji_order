...
class Giveback extends \App\Lib\BaseApi
{
	...
	public static function confirmDelivery( $params ) {
		foreach ($params as $value) {
			self::request(\env('APPID'), \config('ordersystem.ORDER_API'),'api.giveback.confirm.delivery', '1.0', $value);
		}
		return true;
	}
	...
	public static function confirmEvaluation( $params ) {
		if( self::request(\env('APPID'), \config('ordersystem.ORDER_API'),'api.giveback.confirm.evaluation', '1.0', $params) ){
			return true;
		}
	}
	/**
