...
class ApiStatus {
    ...
    const CODE_30006 = '30006'; //[下单] 未完成订单错误
    ...
    const CODE_31009 = '31009'; //[取消订单]访问风控恢复押金接口失败
    const CODE_31010 = '31010'; //[取消订单]申请退款失败
    ...
    const CODE_36001 = '36001';//[退换货]禁止操作
    ...
    const CODE_35000= '35000'; //[小程序程序异常]
    const CODE_35015= '35015'; //[小程序还机扣款记录不存在]
    const CODE_35016= '35016'; //[小程序租机超过2000请先支付租金]
    const CODE_35017= '35017'; //[小程序下单跳转等待处理页面]
    const CODE_35018= '35018'; //[小程序下单跳转无法完成操作页面]
    const CODE_35019= '35019'; //[小程序未支付跳转订单列表页面]
    const CODE_35020= '35020'; //[小程序同步信息接口失败，跳转支付失败页面]
    const CODE_35021= '35021'; //[小程序获取芝麻商品类目失败]
    const CODE_35022= '35022'; //[小程序用户领取优惠券失败]
    const CODE_35023= '35023'; //[释放优惠券失败]
    const CODE_35024= '35024'; //[小程序订单冻结]
    //-+----------------------------------------------------------------------
    // | 订单系统支付阶段错误信息
    //-+----------------------------------------------------------------------
    ...
    const CODE_42002 = '42002'; //[IMEI] 获取数据失败
    const CODE_42003 = '42003'; //[IMEI] 修改数据失败

    //-+----------------------------------------------------------------------
    // | 第三方用户管理
    //-+----------------------------------------------------------------------
    const CODE_70001 = '70001'; //[IMEI] 第三方用户管理添加失败
    const CODE_70002 = '70002'; //[IMEI] 第三方用户管理删除失败
    const CODE_70003 = '70003'; //[IMEI] 第三方用户管理审核失败
    const CODE_70004 = '70004'; //[IMEI] 第三方用户管理匹配相似度失败
    const CODE_70005 = '70005'; //[IMEI] 第三方用户管理查询失败
    const CODE_70006 = '70006'; //[IMEI] 第三方用户管理修改失败
    const CODE_70007 = '70007'; //[IMEI] 第三方用户管理定时任务开始时间失败
    const CODE_70008 = '70008'; //[IMEI] 第三方用户管理定时任务结束时间失败
    const CODE_70009 = '70009'; //[IMEI] 第三方用户管理Excel导入失败
    ...
    // | 支付单
    //-+----------------------------------------------------------------------
    const CODE_90000 = '90000';//无效支付单
    const CODE_90001 = '90004';//已完成
    const CODE_90002 = '90005';//已关闭
     ...
     * [预约]添加失败!
     */
    const CODE_95000 = '95000';
    /**
     * [预约]修改失败!
     */
    const CODE_95001 = '95001';
    /**
     * [预约]获取预约活动信息失败!
     */
    const CODE_95002 = '95002';


    /**
     * [预约]预定金退款失败!
     */
    const CODE_95003 = '95003';
    /**
     * [预约]创建清单失败!
     */
    const CODE_95004 = '95004';

    /**
     * [1元预约]获取预约体验活动信息失败!
     */
    const CODE_95005 = '95005';

    /**
     * [1元预约]活动未开始!
     */
    const CODE_95006 = '95006';
    /**
     * [1元预约]活动已结束!
     */
    const CODE_95007 = '95007';
    /***
     * [逾期扣款
     */
    const CODE_95008 = '95008';
	...
	public static $errCodes = [
        ...
        self::CODE_31009 => '[取消订单]访问风控恢复免押金失败',
        self::CODE_31010 => '[取消订单]申请退款失败',
        ...
        //IMEI
        self::CODE_42001 => '[IMEI]excel数据导入失败',
        self::CODE_42002 => '[IMEI]获取数据失败',
        self::CODE_42003 => '[IMEI]修改数据失败',
        ...
        // 第三方用户管理
        self::CODE_70001 => '第三方用户管理添加失败',
        self::CODE_70002 => '第三方用户管理删除失败',
        self::CODE_70003 => '第三方用户管理审核失败',
        self::CODE_70004 => '第三方用户管理匹配相似度失败',
        self::CODE_70005 => '第三方用户管理查找失败',
        self::CODE_70006 => '第三方用户管理修改失败',
        self::CODE_70007 => '第三方用户管理定时任务开始时间失败',
        self::CODE_70008 => '第三方用户管理定时任务结束时间失败',
        self::CODE_70009 => '第三方用户管理Excel导入失败',
        ...
        // | 小程序订单
        //-+----------------------------------------------------------------------
        self::CODE_35001=> '[小程序][数据错误]创建临时订单失败!', //[小程序订单创建临时订单失败]
        self::CODE_35002=> '[小程序][订单查询错误]本地订单查询失败!', //[小程序订单本地订单查询失败]
        self::CODE_35003=> '[小程序][订单查询错误]芝麻订单查询失败!', //[小程序订单芝麻查询失败]
        self::CODE_35004=> '[小程序][同步状态错误]同步返回状态错误!', //[小程序订单同步返回状态错误]
        self::CODE_35005=> '[小程序][订单数据取消错误]订单取消失败!', //[小程序订单取消失败]
        self::CODE_35006=> '[小程序][请求芝麻接口失败]创建临时订单失败!', //[小程序订单扣款失败]
        self::CODE_35007=> '[小程序][请求芝麻接口处理中]扣款处理中请等待!', //[小程序扣款处理中请等待]
        self::CODE_35008=> '[小程序][请求风控系统失败]添加风控信息处理失败!', //[小程序添加风控信息处理失败]
        self::CODE_35010=> '[小程序][订单查询错误]临时订单查询失败!', //[小程序临时订单查询失败]
        self::CODE_35011=> '[小程序][appid匹配失败]appid匹配失败!', //[小程序appid匹配失败]
        self::CODE_35012=> '[小程序][订单处理错误]确认订单失败!', //[小程序确认订单失败]
        self::CODE_35013=> '[小程序][收货地址信息处理失败]收货地址信息获取失败!', //[小程序收货地址信息获取失败]
        self::CODE_35014=> '[小程序][商品信息获取失败]商品获取失败!', //[小程序商品获取失败]
        self::CODE_35000=> '[小程序][程序异常]异常错误!', //[小程序商品获取失败]
        self::CODE_35000=> '[小程序][小程序程序异常]', //[小程序程序异常]
        self::CODE_35015=> '[小程序][小程序还机扣款记录不存在]', //[小程序还机扣款记录不存在]
        self::CODE_35016=> '[小程序][小程序租机超过2000请先支付租金]', //[小程序租机超过2000请先支付租金]
        self::CODE_35017=> '[小程序][小程序下单跳转等待处理页面]', //[小程序下单跳转等待处理页面]
        self::CODE_35018=> '[小程序][小程序下单跳转无法完成操作页面]', //[小程序下单跳转无法完成操作页面]
        self::CODE_35019=> '[小程序][小程序未支付跳转订单列表页面]', //[小程序未支付跳转订单列表页面]
        self::CODE_35020=> '[小程序][小程序同步信息接口失败，跳转支付失败页面]', //[小程序同步信息接口失败，跳转支付失败页面]
        self::CODE_35021=> '[小程序][小程序获取芝麻商品类目失败]', //[小程序获取芝麻商品类目失败]
        self::CODE_35022=> '[小程序][小程序用户领取优惠券失败]', //[小程序用户领取优惠券失败]
        self::CODE_35023=> '[小程序][释放优惠券失败]', //[释放优惠券失败]


        //预约
        self::CODE_95000=> '[预约]添加失败!',
        self::CODE_95001=> '[预约]修改失败!',
        self::CODE_95002=> '[预约]获取信息失败!',
        self::CODE_95003=> '[预约]预定金退款失败!',
        self::CODE_95004=> '[预约]创建清单失败!',
        self::CODE_95005=> '[预约]获取1元体验信息失败!',
        self::CODE_95006=> '[预约]活动未开始!',
        self::CODE_95007=> '[预约]活动已结束!',
        //逾期扣款
        self::CODE_95008=> '[逾期]创建回访失败',
    ];
