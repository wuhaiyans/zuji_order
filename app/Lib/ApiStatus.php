...
class ApiStatus {
    ...
    // | 退货退款错误信息
    //-+----------------------------------------------------------------------
    const CODE_33001 = '33001'; //[退换货]审核失败
    const CODE_33002 = '33002'; //[退换货]此订单不符合规则
    const CODE_33003 = '33003'; //[退换货]不允许申请
    ...
    const CODE_34007 = '34007'; //[退换货]创建失败
...
//-+----------------------------------------------------------------------
	...
	public static $errCodes = [
        ...
        //退换货信息
        self::CODE_33001 => '[退换货]审核失败',
        self::CODE_33002 => '[退换货]此订单不符合规则',
        self::CODE_33003 => '[退换货]不允许申请',
